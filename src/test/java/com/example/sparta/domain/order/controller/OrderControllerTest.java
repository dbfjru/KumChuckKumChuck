...
class OrderControllerTest {
  ...
  class createOrder {
    ...
    void createOrder_success() throws Exception {
      ...
      given(orderServiceImpl.createOrder(any(CreateOrderRequestDto.class),
  ...
  class deleteOrder {
    ...
    void deleteOrder_success() throws Exception {
      //given
      Long orderId = 1L;
      given(orderServiceImpl.deleteOrder(any(User.class), any(Long.class))).willReturn(orderId);
    ...
    void deleteOrder_fail() throws Exception {
      //given
      given(orderServiceImpl.deleteOrder(any(User.class), any(Long.class))).willThrow(
  ...
  class modifyOrderRequests {
    ...
    void modifyOrderRequest_success() throws Exception {
      ...
      given(orderServiceImpl.modifyOrderRequest(any(User.class), any(Long.class),
  ...
  class getOrder {
    ...
    class singleOrder {
      ...
      void getSingleOrder_success() throws Exception {
        ...
        given(orderServiceImpl.getOrder(any(User.class), any(Long.class))).willReturn(
            orderResponseDto);
      ...
      void getSingleOrder_fail() throws Exception {
        //given
        given(orderServiceImpl.getOrder(any(User.class), any(Long.class))).willThrow(
            new IllegalArgumentException());
    ...
    class listOfOrders {
      ...
      void getListOfOrder_success() throws Exception {
        ...
        given(orderServiceImpl.getOrderList(any(User.class))).willReturn(orderResponseDtoList);
      ...
      void getListOfOrder_fail() throws Exception {
        //given
        given(orderServiceImpl.getOrderList(any(User.class))).willThrow(
